...
def test_near_third_buy_limit_caps_tp_at_2x_sl(monkeypatch):
    from app.services.execution_service import execute_trade
...
def test_middle_third_buy_limit_keeps_ai_tp(monkeypatch):
    from app.services.execution_service import execute_trade
    ...
    payload = {
        ...
        "entry_timeframe": {"market_structure": {"trend": "BULLISH"}},
        "smc": {
            "order_blocks": {"demand": [{"low": 95.0, "high": 96.0, "index": 8}], "supply": []},
            "choch": {"m5": {"bullish_choch": True}},
            "fvg_zones": [],
            "liquidity_levels": [],
        },
